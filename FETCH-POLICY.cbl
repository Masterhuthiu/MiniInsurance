      ...
      * DINH DANG DONG HIEN THI
       ...
       01  POL-REC-VARS.
           ...
           05  POL-PREMIUM         PIC  S9(10)V99 COMP-3.
       ...
       MAIN-RTN.
           ...
           DISPLAY "---------- -------------------- ----------- ----------".
           DISPLAY "ID         CHU DON              PHI BH      TRANG THAI".
           DISPLAY "---------- -------------------- ----------- ----------".
           
           EXEC SQL 
               FETCH C1 INTO :POL-ID, :POL-HOLDER, :POL-PREMIUM, :POL-STATUS
           END-EXEC.
